...
- (void)namedQueryGetChangesApp:(FirestorePigeonFirebaseApp *)app name:(NSString *)name options:(PigeonGetOptions *)options completion:(void (^)(PigeonQuerySnapshotChanges *_Nullable, FlutterError *_Nullable))completion;
...
- (void)queryGetChangesApp:(FirestorePigeonFirebaseApp *)app path:(NSString *)path isCollectionGroup:(NSNumber *)isCollectionGroup parameters:(PigeonQueryParameters *)parameters options:(PigeonGetOptions *)options completion:(void (^)(PigeonQuerySnapshotChanges *_Nullable, FlutterError *_Nullable))completion;
...
- (void)querySnapshotChangesApp:(FirestorePigeonFirebaseApp *)app path:(NSString *)path isCollectionGroup:(NSNumber *)isCollectionGroup parameters:(PigeonQueryParameters *)parameters options:(PigeonGetOptions *)options includeMetadataChanges:(NSNumber *)includeMetadataChanges source:(ListenSource)source completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
