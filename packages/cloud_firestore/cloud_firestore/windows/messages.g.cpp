...
void PigeonQuerySnapshotChanges::set_document_changes(const EncodableList& value_arg) {
  document_changes_ = value_arg;
}
...
void PigeonQuerySnapshotChanges::set_metadata(const PigeonSnapshotMetadata& value_arg) {
  metadata_ = value_arg;
}
...
PigeonQuerySnapshotChanges PigeonQuerySnapshotChanges::FromEncodableList(const EncodableList& list) {
  PigeonQuerySnapshotChanges decoded(
    std::get<EncodableList>(list[0]),
    PigeonSnapshotMetadata::FromEncodableList(std::get<EncodableList>(list[1])));
  return decoded;
}
...
EncodableValue FirebaseFirestoreHostApiCodecSerializer::ReadValueOfType(
  ...
  switch (type) {
    ...
    case 139:
      return CustomEncodableValue(PigeonQuerySnapshotChanges::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 140:
...
void FirebaseFirestoreHostApiCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value = std::get_if<CustomEncodableValue>(&value)) {
    ...
    if (custom_value->type() == typeid(PigeonQuerySnapshotChanges)) {
      ...
      WriteValue(EncodableValue(std::any_cast<PigeonQuerySnapshotChanges>(*custom_value).ToEncodableList()), stream);
      return;
    }
...
void FirebaseFirestoreHostApi::SetUp(
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.namedQueryGetChanges", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& options_arg = std::any_cast<const PigeonGetOptions&>(std::get<CustomEncodableValue>(encodable_options_arg));
          api->NamedQueryGetChanges(app_arg, name_arg, options_arg, [reply](ErrorOr<PigeonQuerySnapshotChanges>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.queryGetChanges", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& options_arg = std::any_cast<const PigeonGetOptions&>(std::get<CustomEncodableValue>(encodable_options_arg));
          api->QueryGetChanges(app_arg, path_arg, is_collection_group_arg, parameters_arg, options_arg, [reply](ErrorOr<PigeonQuerySnapshotChanges>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.querySnapshotChanges", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const ListenSource& source_arg = (ListenSource)encodable_source_arg.LongValue();
          api->QuerySnapshotChanges(app_arg, path_arg, is_collection_group_arg, parameters_arg, options_arg, include_metadata_changes_arg, source_arg, [reply](ErrorOr<std::string>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.persistenceCacheIndexManagerRequest", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const PersistenceCacheIndexManagerRequest& request_arg = (PersistenceCacheIndexManagerRequest)encodable_request_arg.LongValue();
          api->PersistenceCacheIndexManagerRequest(app_arg, request_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
