...
class PigeonQuerySnapshotChanges {
  ...
  static PigeonQuerySnapshotChanges decode(Object result) {
    ...
    return PigeonQuerySnapshotChanges(
      documentChanges: (result[0] as List<Object?>?)!.cast<PigeonDocumentChange?>(),
...
class FirebaseFirestoreHostApi {
  ...
  Future<PigeonQuerySnapshotChanges> namedQueryGetChanges(FirestorePigeonFirebaseApp arg_app, String arg_name, PigeonGetOptions arg_options) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<PigeonQuerySnapshotChanges> queryGetChanges(FirestorePigeonFirebaseApp arg_app, String arg_path, bool arg_isCollectionGroup, PigeonQueryParameters arg_parameters, PigeonGetOptions arg_options) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<String> querySnapshotChanges(FirestorePigeonFirebaseApp arg_app, String arg_path, bool arg_isCollectionGroup, PigeonQueryParameters arg_parameters, PigeonGetOptions arg_options, bool arg_includeMetadataChanges, ListenSource arg_source) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<void> persistenceCacheIndexManagerRequest(FirestorePigeonFirebaseApp arg_app, PersistenceCacheIndexManagerRequest arg_request) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
